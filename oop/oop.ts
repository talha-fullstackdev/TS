...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
class Employee{  // we can also mad constructor like this without using property agian and agian like we did in upper classes  , here but we have to use access modifers to use this functionality ,this will also reduce our code
    constructor(
       public name:string,
        public age:number,
...
const emp1 :Employee = new Employee("talha",24,"male")
console.log(emp1)